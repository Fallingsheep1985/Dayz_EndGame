...
if (!isDedicated) then {
	...
	dayz_spaceInterrupt =			compile preprocessFileLineNumbers "custom\PlotForLifev2\dayz_spaceInterrupt.sqf";
	...
	player_crackVault =			compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\player_crackVault.sqf";
